...
public abstract class AbstractCreateSiriusDiagramEditorCommand implements ICreateSiriusDiagramEditorCommand {
	...
	protected DocumentTemplate execute(final DocumentTemplatePrototype documentTemplatePrototype, final String documentName, final EObject semanticContext, final EObject graphicalContext, final boolean openAfterCreation) {
		...
		final CreateSiriusDiagramEditorViewCommand command = createDocumentTemplateEditorCreationCommand(domain, documentTemplatePrototype, documentName, documentMainTitle, semanticContext, openAfterCreation);
	 ...
	 *         the created {@link DocumentTemplate}
	 */
	public CreateSiriusDiagramEditorViewCommand createDocumentTemplateEditorCreationCommand(final TransactionalEditingDomain editingDomain,
