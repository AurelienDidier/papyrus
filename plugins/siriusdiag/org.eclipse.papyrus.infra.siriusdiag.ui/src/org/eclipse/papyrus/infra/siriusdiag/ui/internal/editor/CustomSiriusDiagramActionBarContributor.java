 ...
 */
public class CustomSiriusDiagramActionBarContributor
	 ...
	 *
	 */
	public CustomSiriusDiagramActionBarContributor() {
		super();
	}

	/**
	 * @see org.eclipse.papyrus.infra.siriusdiag.presentation.SiriusDiagramActionBarContributor#contributeToMenu(org.eclipse.jface.action.IMenuManager)
	 *
	 * @param menuManager
	 */
	@Override
	...
	/**
	 *
	 * @see org.eclipse.papyrus.infra.siriusdiag.presentation.SiriusDiagramActionBarContributor#extractSubmenuActions(java.util.Collection)
	 *
	 * @param createActions
	 * @return
	 */
	...
	/**
	 * @see org.eclipse.papyrus.infra.siriusdiag.presentation.SiriusDiagramActionBarContributor#populateManager(org.eclipse.jface.action.IContributionManager, java.util.Collection, java.lang.String)
	 *
	 * @param manager
	 * @param actions
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action("ShowPropertiesView_menu_item") //$NON-NLS-1$
	{
		@Override
		public void run() {
			try {
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action("Refresh viewer") //$NON-NLS-1$
	{
		@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("documentstructuretemplate-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("documentstructuretemplate-additions")); //$NON-NLS-1$
	}
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager("Create child menu"); //$NON-NLS-1$
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager); //$NON-NLS-1$

		submenuManager = new MenuManager("Create siblings menu"); //$NON-NLS-1$
