 ...
 *
 */
public class GetSiriusDiagramIconQuery implements IJavaQuery2<DDiagram, IImage> {
	 ...
	 */
	@Override
	public IImage evaluate(final DDiagram context, final IParameterValueList2 parameterValues, final IFacetManager facetManager) throws DerivedTypedElementException {
