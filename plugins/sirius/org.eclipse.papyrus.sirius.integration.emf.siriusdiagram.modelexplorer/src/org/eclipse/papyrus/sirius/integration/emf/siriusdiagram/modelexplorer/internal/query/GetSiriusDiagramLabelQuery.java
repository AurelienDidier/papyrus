 ...
 *
 */
public class GetSiriusDiagramLabelQuery implements IJavaQuery2<DDiagram, String> {

	/**
	 * {@inheritDoc}
	 */
	@Override
	public String evaluate(final DDiagram context, final IParameterValueList2 parameterValues, final IFacetManager facetManager) throws DerivedTypedElementException {
