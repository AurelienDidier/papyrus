 ...
 * {@link org.eclipse.sirius.diagram.description.tool.SourceEdgeCreationVariable} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class SourceEdgeCreationVariableItemProvider extends AbstractVariableItemProvider {
    ...
    /**
     * This returns SourceEdgeCreationVariable.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SourceEdgeCreationVariable")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_SourceEdgeCreationVariable_type") : //$NON-NLS-1$
                getString("_UI_SourceEdgeCreationVariable_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
