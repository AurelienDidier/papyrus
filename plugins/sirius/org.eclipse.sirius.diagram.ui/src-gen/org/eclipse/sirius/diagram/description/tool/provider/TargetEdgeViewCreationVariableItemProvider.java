 ...
 * {@link org.eclipse.sirius.diagram.description.tool.TargetEdgeViewCreationVariable} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class TargetEdgeViewCreationVariableItemProvider extends AbstractVariableItemProvider {
    ...
    /**
     * This returns TargetEdgeViewCreationVariable.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/TargetEdgeViewCreationVariable")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_TargetEdgeViewCreationVariable_type") : //$NON-NLS-1$
                getString("_UI_TargetEdgeViewCreationVariable_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
