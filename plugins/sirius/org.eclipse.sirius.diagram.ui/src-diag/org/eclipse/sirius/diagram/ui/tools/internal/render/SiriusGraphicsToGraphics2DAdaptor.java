...
public class SiriusGraphicsToGraphics2DAdaptor extends Graphics implements DrawableRenderedImage {
     ...
     */
    public SiriusGraphicsToGraphics2DAdaptor(Graphics2D graphics, Rectangle viewPort) {
     ...
     *            object.
     */
    public SiriusGraphicsToGraphics2DAdaptor(Graphics2D graphics, org.eclipse.swt.graphics.Rectangle viewPort) {
    ...
    /*
     * (non-Javadoc)
     * @see org.eclipse.draw2d.Graphics#getClip(org.eclipse.draw2d.geometry.
     * Rectangle)
     */
    @Override
    ...
    private GeneralPath createPathAWT(Path path) {
        ...
        for (int i = 0; i < pathData.types.length; i++) {
            ...
            case SWT.PATH_CUBIC_TO:
                pathAWT.curveTo(pathData.points[idx++] + transX, pathData.points[idx++] + transY, pathData.points[idx++] + transX, pathData.points[idx++] + transY, pathData.points[idx++] + transX,
     ...
     * DrawableRenderedImage#drawRenderedImage(org.eclipse.gmf.runtime.draw2d.ui
     * .render.RenderedImage, org.eclipse.draw2d.geometry.Rectangle,
