 ...
 * @was-generated
 */
public class DNodeListViewNodeListCompartment2ViewFactory extends BasicNodeViewFactory {
    ...
    protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
        if (semanticHint == null) {
            semanticHint = SiriusVisualIDRegistry.getType(DNodeListViewNodeListCompartment2EditPart.VISUAL_ID);
