...
public interface DiagramImagesPath {
     ...
     */
    String STRAIGHTEN_TO_BOTTOM = "icons/straightenToBottom.png"; //$NON-NLS-1$

    /**
     * Path of the action's image to straighten to left.
     */
    String STRAIGHTEN_TO_LEFT = "icons/straightenToLeft.png"; //$NON-NLS-1$

    /**
     * Path of the action's image to straighten to right.
     */
    String STRAIGHTEN_TO_RIGHT = "icons/straightenToRight.png"; //$NON-NLS-1$
