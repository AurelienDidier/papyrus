...
package org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.internal.custom;
...
import org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.impl.SiriusDiagramPrototypeImpl;
 ...
 */
public class CustomPapyrusDiagramPrototypeImpl extends SiriusDiagramPrototypeImpl {

	// the 2 next field could be in org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.types, but we want to avoid a dependency between these plugins
	// TODO : try to solve this point
	/**
	 * the name of the required element type
	 */
	private static final String REQUIRED_ELEMENT_TYPE_NAME = "SiriusDiagramContext"; //$NON-NLS-1$

	/**
	 * the ID of the required element type
	 */
	private static final String REQUIRED_ELEMENT_TYPE_IDENTIFIER = "org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.types.elementTypeSet"; //$NON-NLS-1$

	/**
	 * @see org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.impl.SiriusDiagramPrototypeImpl#isValidClass(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 *
	 * @param chain
	 * @param context
	 * @return
