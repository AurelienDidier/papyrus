 ...
 * <!-- end-model-doc -->
 *
 * @see org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.RepresentationFactory
 * @model kind="package"
 * @generated
 */
public interface RepresentationPackage extends EPackage {
	 ...
	 * @generated
	 */
	RepresentationPackage eINSTANCE = org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.impl.RepresentationPackageImpl.init();

	/**
	 * The meta object id for the '{@link org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.impl.SiriusDiagramPrototypeImpl <em>Papyrus Document Prototype</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @see org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.impl.SiriusDiagramPrototypeImpl
	 * @see org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.impl.RepresentationPackageImpl#getPapyrusDocumentPrototype()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.SiriusDiagramPrototype <em>Papyrus Document Prototype</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @return the meta object for class '<em>Papyrus Document Prototype</em>'.
	 * @see org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.SiriusDiagramPrototype
	 * @generated
	 */
	EClass getPapyrusDocumentPrototype();

	/**
	 * Returns the meta object for the reference '{@link org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.SiriusDiagramPrototype#getSiriusDiagramPrototype <em>Document Template Prototype</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @return the meta object for the reference '<em>Document Template Prototype</em>'.
	 * @see org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.SiriusDiagramPrototype#getSiriusDiagramPrototype()
	 * @see #getPapyrusDocumentPrototype()
	 * @generated
	 */
	EReference getPapyrusDocumentPrototype_SiriusDiagramPrototype();

	/**
	 * Returns the meta object for the attribute '{@link org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.SiriusDiagramPrototype#getCreationCommandClass <em>Creation Command Class</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @return the meta object for the attribute '<em>Creation Command Class</em>'.
	 * @see org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.SiriusDiagramPrototype#getCreationCommandClass()
	 * @see #getPapyrusDocumentPrototype()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the '{@link org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.SiriusDiagramPrototype#isValidClass(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Is Valid Class</em>}'
	 * operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @return the meta object for the '<em>Is Valid Class</em>' operation.
	 * @see org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.SiriusDiagramPrototype#isValidClass(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.impl.SiriusDiagramPrototypeImpl <em>Papyrus Document Prototype</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 *
		 * @see org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.impl.SiriusDiagramPrototypeImpl
		 ...
		 * @generated
		 */
		EReference PAPYRUS_DOCUMENT_PROTOTYPE__DOCUMENT_TEMPLATE_PROTOTYPE = eINSTANCE.getPapyrusDocumentPrototype_SiriusDiagramPrototype();
