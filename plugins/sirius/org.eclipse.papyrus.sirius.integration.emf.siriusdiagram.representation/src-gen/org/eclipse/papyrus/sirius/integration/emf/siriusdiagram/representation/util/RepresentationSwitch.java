...
public class RepresentationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RepresentationPackage.PAPYRUS_DOCUMENT_PROTOTYPE: {
			SiriusDiagramPrototype papyrusDocumentPrototype = (SiriusDiagramPrototype) theEObject;
			T result = casePapyrusDocumentPrototype(papyrusDocumentPrototype);
			if (result == null) {
				result = casePapyrusRepresentationKind(papyrusDocumentPrototype);
			}
			if (result == null) {
				result = caseRepresentationKind(papyrusDocumentPrototype);
			}
			if (result == null) {
				result = caseADElement(papyrusDocumentPrototype);
			}
			if (result == null) {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Papyrus Document Prototype</em>'.
	 * <!-- begin-user-doc -->
