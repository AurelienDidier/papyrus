...
// We must move it.
public class PapyrusSiriusDiagramViewPrototype extends ViewPrototype implements ExtendedViewPrototype<DDiagram> {
	 ...
	 */
	public PapyrusSiriusDiagramViewPrototype(final SiriusDiagramPrototype prototype, final ICreateSiriusDiagramEditorCommand command) {
		super(prototype);
	...
	public EObject getOwnerOf(EObject view) {
		...
		return ((DDiagram) view).eContainer();// TODO: test if eContainer() or root.
	}
