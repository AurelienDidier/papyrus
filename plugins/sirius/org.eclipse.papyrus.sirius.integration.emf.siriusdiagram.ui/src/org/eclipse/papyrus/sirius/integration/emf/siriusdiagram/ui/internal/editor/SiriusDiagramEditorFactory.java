...
import org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.ui.internal.provider.SiriusDiagramLabelProvider;
...
/**
 * Factory for the siriusdiagramEditor
 *
 */
public class SiriusDiagramEditorFactory extends AbstractEditorFactory {
	...
	public SiriusDiagramEditorFactory() {
		// we don't use the type for the DDiagram models
	...
	public boolean isPageModelFactoryFor(Object pageIdentifier) {
		return pageIdentifier instanceof DDiagram;
	}
	...
	private class DocumentViewEditorModel extends AbstractPageModel implements IEditorModel {
		...
		public DocumentViewEditorModel(Object pageIdentifier, ServicesRegistry servicesRegistry, ILabelProvider labels) {
			...
			this.rawModel = (DDiagram) pageIdentifier;
		...
		public IEditorPart createIEditorPart() throws PartInitException {
			try {
				...
				Constructor<?> c = getDiagramClass().getConstructor(ServicesRegistry.class, DDiagram.class);
				...
				// programmer.
				throw new PartInitException("Can't create siriusdiagramView", e); //$NON-NLS-1$
			}
