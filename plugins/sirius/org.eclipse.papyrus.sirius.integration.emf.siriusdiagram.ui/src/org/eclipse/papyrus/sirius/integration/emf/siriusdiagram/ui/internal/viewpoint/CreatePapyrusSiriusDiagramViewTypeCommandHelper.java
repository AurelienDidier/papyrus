 ...
 *****************************************************************************/
package org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.ui.internal.viewpoint;
...
import org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.ui.Activator;
 ...
 *
 */
public class CreatePapyrusSiriusDiagramViewTypeCommandHelper implements IViewTypeHelper {

	/**
	 * The cache of prototypes
	 */
	private Map<PapyrusRepresentationKind, PapyrusSiriusDiagramViewPrototype> cache;
	...
	public boolean isSupported(EClass type) {
		return EcoreUtil.equals(type, org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.RepresentationPackage.eINSTANCE.getPapyrusDocumentPrototype());
	}
		...
		if (creationCommandClass != null) {
			try {
				...
				if (newInstance instanceof ICreateSiriusDiagramEditorCommand) {
					...
					PapyrusSiriusDiagramViewPrototype proto = new PapyrusSiriusDiagramViewPrototype(papyrusDocument, command);
	...
	public ViewPrototype getPrototypeOf(EObject view) {
		...
		SiriusDiagramPrototype repKind = (SiriusDiagramPrototype) manager.getRepresentationKindById(((DDiagram) view).getUid());// getRepresentationKindById(((Document) view)
