...
package org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.ui.internal.provider;
...
public class SiriusDiagramLabelProvider extends ViewPrototypeLabelProvider implements IFilteredLabelProvider {
	...
	public boolean accept(Object object) {
		...
		return EMFHelper.getEObject(object) instanceof DDiagram;
	}
	...
	protected String getName(final EObject object) {
		...
		if (object instanceof DDiagram) {
			value = ((DDiagram) object).getName(); // TODO internationalization to manage here
		}
