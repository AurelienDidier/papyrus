 ...
 *
 */
public class SiriusDiagramModel extends AbstractDynamicModel<DDiagram> {

	/**
	 * Document Model ID.
	 */
	public static final String DOCUMENT_MODEL_ID = "org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.ui.SiriusDiagram"; //$NON-NLS-1$

	/**
	 * the file extension where document are stored.
	 */
	public static final String SIRIUS_DIAGRAM_FILE_EXTENSION = "aird"; // $NON-NLS-1$
	...
	protected String getModelFileExtension() {
		return SIRIUS_DIAGRAM_FILE_EXTENSION;
	}
	 ...
	 * @param newInstance
	 * @param context
	 *            we need the context to be able to calculate the resource name were the DDiagram will be saved.
	 *            because this value is maybe not yet set to {@link SiriusDiagram#setSemanticContext(EObject)}
	 */
	...
	protected boolean isSupportedRoot(EObject object) {
		return object instanceof DDiagram;
	}
