 ...
 */
package org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.provider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.sirius.integration.emf.siriusdiagram.representation.SiriusDiagramPrototype} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class PapyrusDiagramPrototypeItemProvider extends PapyrusRepresentationKindItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PapyrusDiagramPrototypeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSiriusDiagramPrototypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_PapyrusDocumentPrototype_SiriusDiagramPrototype_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_PapyrusDocumentPrototype_SiriusDiagramPrototype_feature", "_UI_PapyrusDocumentPrototype_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
