...
import static org.eclipse.papyrus.toolsmiths.validation.profile.constants.ProfilePluginValidationConstants.STATIC_PROFILE_BINARY_BUILD_PATH;
		...
		case ProfilePluginValidationConstants.UMLPROFILE_EXTENSION_POINT:
			...
			if (iconPath != null && !iconPath.isBlank()) {
				...
				if (iconFile.exists() && !binaryBuildContains(iconFile.getProjectRelativePath())) {
					...
					data.put(STATIC_PROFILE_BINARY_BUILD_PATH, iconPath);
